...
public:
	...
	{
		jfieldID alive = minecraft->m_jenv->GetFieldID(minecraft->m_jenv->GetObjectClass(java_class), "D", "()Z");
		return minecraft->m_jenv->GetBooleanField(java_class, alive);
	}
	...
	float get_motionx()
	{
		jfieldID motionvalue = minecraft->m_jenv->GetFieldID(minecraft->m_jenv->GetObjectClass(java_class), "v", "F");
		return minecraft->m_jenv->GetFloatField(java_class, motionvalue);
	}

	float get_motiony()
	{
		jfieldID motionvalue = minecraft->m_jenv->GetFieldID(minecraft->m_jenv->GetObjectClass(java_class), "w", "F");
		return minecraft->m_jenv->GetFloatField(java_class, motionvalue);
	}

	float get_motionz()
	{
		jfieldID motionvalue = minecraft->m_jenv->GetFieldID(minecraft->m_jenv->GetObjectClass(java_class), "x", "F");
		return minecraft->m_jenv->GetFloatField(java_class, motionvalue);
	}

	void set_motionx(jfloat value)
	{
		jfieldID motionvalue = minecraft->m_jenv->GetFieldID(minecraft->m_jenv->GetObjectClass(java_class), "v", "F");
		minecraft->m_jenv->SetFloatField(java_class, motionvalue, value);
	}

	void set_motiony(jfloat value)
	{
		jfieldID motionvalue = minecraft->m_jenv->GetFieldID(minecraft->m_jenv->GetObjectClass(java_class), "w", "F");
		minecraft->m_jenv->SetFloatField(java_class, motionvalue, value);
	}

	void set_motionz(jfloat value)
	{
		jfieldID motionvalue = minecraft->m_jenv->GetFieldID(minecraft->m_jenv->GetObjectClass(java_class), "x", "F");
		minecraft->m_jenv->SetFloatField(java_class, motionvalue, value);
	}
